...
{
    public class LinSpace05 : ITestCreator, ITest, ITestGroup, ITimeLimit
    {
        public int TestID { get; set; }
        public string Name { get; } = "Базис подпространства01.1";
        ...
        public ITest CreateTest(int randomSeed)
        {
            ...
            result.Text =
                ...
                $"\\(\\left\\{{ x - <Cx1:3>, x^{{2}} - <Cx2:3>, x^{{3}}-<Cx3:3> \\right\\}}\\).";
        ...
        public int CheckAnswer(int randomSeed, Dictionary<string, string> answers)
        {
            ...
            if (answers.TryGetValue("Cx1", out var va) && int.TryParse(va, out var va1) && va1 == Cx) total++;
            if (answers.TryGetValue("Cx2", out var va2) && int.TryParse(va2, out var va21) && va21 == Cx*Cx) total++;
            if (answers.TryGetValue("Cx3", out var va3) && int.TryParse(va3, out var va31) && va31 == Cx*Cx*Cx) total++;
